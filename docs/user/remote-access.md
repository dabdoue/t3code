...
see [Keeping T3 Code in Sync](./updating.md). For updating this fork's server on another Linux
machine, see [Update this fork's server on another Linux machine](./fork-installs.md).
