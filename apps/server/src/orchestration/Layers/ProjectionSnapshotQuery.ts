    ...
    execute: () =>
      sql`
        SELECT
          ...
          fork_point_message_id AS "forkPointMessageId",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                forkPointMessageId: row.forkPointMessageId ?? null,
                forkKind: row.forkKind ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        worktreePath: threadRow.value.worktreePath,
        forkedFromThreadId: threadRow.value.forkedFromThreadId ?? null,
        forkPointMessageId: threadRow.value.forkPointMessageId ?? null,
        forkKind: threadRow.value.forkKind ?? null,
