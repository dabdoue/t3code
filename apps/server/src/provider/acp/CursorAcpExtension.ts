...
/** Cursor reports subagent lifecycle through this extension rather than a nested ACP session. */
...
export function cursorTaskRole(
  ...
  if (subagentType === undefined) return undefined;
...
/** Use the always-present tool call id so start and completion update one Agents-panel row. */
