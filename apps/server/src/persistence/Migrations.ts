...
import Migration0041 from "./Migrations/041_ProjectionTurnIntentSequence.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionTurnIntentSequence", Migration0041],
  // Upstream 0.0.38 migrations renumbered 41-44 -> 45-48: the
  // fork's own 41 (ProjectionTurnIntentSequence) shipped first to daily-driver
  // databases, so the upstream batch must not reuse its id.
