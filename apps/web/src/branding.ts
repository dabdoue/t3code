...
import { normalizeForkRevision } from "@t3tools/shared/forkRevision";
...
export const APP_FORK_REVISION = normalizeForkRevision(import.meta.env.T3CODE_FORK_REVISION);
